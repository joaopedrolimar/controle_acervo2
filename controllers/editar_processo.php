...
<body class="bg-light">
     ...
     <div class="card-body">
      <form action="" method="POST">
       ...
       <div class="mb-3">
        ...
        <input type="checkbox" id="semVitima" name="sem_vitima" value="1"
 ...
 function toggleVitima() {
  const check = document.getElementById("semVitima");
  const campoVitima = document.getElementById("vitima");

  if (check.checked) {
   campoVitima.value = "Não há";
   campoVitima.disabled = true;
  } else {
   campoVitima.disabled = false;
  }
 }
