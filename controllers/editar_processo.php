         ...
         value="<?= $processo['data_recebimento_denuncia'] ?? '' ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="sentenca" name="sentenca" onchange="toggleSentenca()"
                                    required>
                                    <option value="Condenatória"
                                        <?= $processo['sentenca'] == "Condenatória" ? "selected" : "" ?>>Condenatória
                                    </option>
                                    <option value="Absolutória"
                                        <?= $processo['sentenca'] == "Absolutória" ? "selected" : "" ?>>Absolutória
                                    </option>
                                    <option value="Prescrição"
                                        <?= $processo['sentenca'] == "Prescrição" ? "selected" : "" ?>>Prescrição
                                    </option>
                                ...
                                <input type="text" class="form-control mt-2" id="outraSentenca" name="outra_sentenca"
                                    placeholder="Especifique outra sentença..."
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="recursos" name="recursos" required>
                                    <option value="Acusação"
                                        <?= $processo['recursos'] == "Acusação" ? "selected" : "" ?>>Acusação</option>
