                        ...
                        <tbody>
                            <?php foreach ($crimes as $crime): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="../controllers/deletar_item.php" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este crime?');">
                        ...
                        <tbody>
                            <?php foreach ($municipios as $municipio): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="../controllers/deletar_item.php" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este município?');">
                        ...
                        <tbody>
                            <?php foreach ($bairros as $bairro): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="../controllers/deletar_item.php" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este bairro?');">
